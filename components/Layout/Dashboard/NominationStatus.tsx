...
import { FiUserPlus, FiCheckCircle, FiClock, FiUser } from 'react-icons/fi';
  ...
  return (
    <div className="bg-white shadow-sm rounded-xl border border-gray-100 overflow-hidden">
      ...
      <div className="px-6 py-3 bg-gray-50 border-t border-gray-100">
        <button className="w-full flex items-center justify-center bg-gradient-to-r from-teal-500 to-emerald-500 hover:from-teal-600 hover:to-emerald-600 text-white py-2.5 px-4 rounded-lg text-sm font-medium transition-colors">
