  ...
  return (
    <div className="edge-navbar">
      ...
      <nav className="bg-black fixed top-0 left-0 w-full h-auto flex flex-col z-[1000]">
        ...
        <div className="hidden lg:block bg-gray-900 border-t border-deepGold/20">
          <div className="container mx-auto px-4 py-4">
            <div className="flex justify-center items-center space-x-10">
              {secondaryNavlinks.map((item: SecondaryNavLinkWithChildren, index) => (
                <div key={index} className="relative group mx-2 secondary-nav-item">
                  {item.children ? (
                    <>
          ...
          <div className="overflow-y-auto h-full pb-20">
            <div className="py-4">
              ...
              <div className="border-t border-gray-800 mt-4 pt-4 px-4">
                {user ? (
                  <>
                    <div className="text-gray-400 mb-2">Account</div>
                    <Link
                      href="/dashboard"
