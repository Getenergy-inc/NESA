...
const AboutHeader2: React.FC = () => {
  return (
    <section className="relative bg-gradient-to-b from-white to-[#fff7ec] py-24 px-6 md:px-16">
      <div className="max-w-7xl mx-auto text-center">
        ...
        >
          Why <span className="text-[#f59e0b]">NESA Africa ?</span>
        </motion.h2>
        <motion.div
          ...
          viewport={{ once: true }}
          className="h-1 bg-[#f59e0b] mx-auto mb-16 rounded-full"
        />
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative bg-white shadow-xl rounded-2xl p-10 text-left hover:shadow-2xl transition duration-300"
          >
            {/* Floating Accent */}
            <div className="absolute -top-6 -left-6 w-20 h-20 bg-[#f59e0b]/20 rounded-full blur-xl -z-10" />
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              To ignite transformative change within Nigeria and Africa’s 
              educational sectors — creating an environment where  
              <span className="font-semibold text-[#f59e0b]"> excellence</span> 
          ...
          >
            {/* Floating Accent */}
            <div className="absolute -bottom-6 -right-6 w-20 h-20 bg-[#f59e0b]/20 rounded-full blur-xl -z-10" />
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              To acknowledge and encourage every effort that enhances education 
              across Africa — motivating stakeholders to invest, innovate, and 
              uplift standards. Our goal: a future where  
              <span className="font-semibold text-[#f59e0b]"> every child</span>  
