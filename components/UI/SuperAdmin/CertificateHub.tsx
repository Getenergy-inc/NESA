...
// // Define row props for react-window
// type RowProps = {
//   index: number;
//   style: React.CSSProperties;
//   data: typeof certificates;
// };

// const CertificateRow: React.FC<RowProps> = ({ index, style, data }) => {
//   const cert = data[index];
//   return (
//     <tr style={style} className="border-b text-white border-gray-100 dark:border-gray-700">
//       <td className="p-2">{cert.id}</td>
//       <td className="p-2">{cert.name}</td>
//       <td className="p-2">{cert.award}</td>
//       <td className="p-2">
//         <span
//           className={`px-2 py-1 rounded-lg text-xs sm:text-sm font-medium ${statusColors[cert.status]}`}
//         >
//           {cert.status}
//         </span>
//       </td>
...
//       cert ? `✅ Valid Certificate issued to ${cert.name}` : "❌ Certificate not found"
//     );
//   };

//   // Memoize certificates for performance
//   const data = useMemo(() => certificates, []);
...
//           <tbody>
//             <List
//               height={200} // adjust table scroll height
