...
// ✅ move configs outside so they aren’t recreated
const fadeInUp = { hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } };
const goldCategories = Array.from({ length: 3 }, (_, i) => `category-${i}`);
const platinumCategories = Array.from({ length: 2 }, (_, i) => `institution-${i}`);
...
const AwardControlCenter: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Heading */}
      <motion.h1
        className="text-xl sm:text-2xl font-extrabold text-white flex items-center gap-2"
        initial="hidden"
        animate="visible"
        variants={fadeInUp}
        transition={{ duration: 0.5 }}
...
export default memo(AwardControlCenter);
