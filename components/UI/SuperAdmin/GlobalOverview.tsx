...
// ✅ Dynamically import heavy Recharts components
...
const GlobalOverview: React.FC = () => {
  ...
  // ✅ Static data memoized so it's not re-created on re-renders
  const kpis = useMemo(
    () => [
      { name: "Total Nominations", value: 2847 },
      { name: "Approved Nominees", value: 1924 },
  ...
  const walletData = useMemo(
    () => [
      { day: "Mon", nominee: 300, public: 200 },
      { day: "Tue", nominee: 400, public: 250 },
      { day: "Wed", nominee: 350, public: 300 },
      { day: "Thu", nominee: 500, public: 280 },
      { day: "Fri", nominee: 450, public: 320 },
    ],
    []
  );

  // ✅ Memoized KPI rendering
        ...
        <Card className="shadow-md rounded-2xl mb-6">
          <CardContent className="p-4">
            ...
            <Tabs value={activeTab} onValueChange={handleTabChange}>
              <TabsList className="flex gap-2 mb-4 overflow-x-auto rounded-full">
                <TabsTrigger value="blue-garnet" className="rounded-full">
                  Blue Garnet
                </TabsTrigger>
                <TabsTrigger value="blue-gold" className="rounded-full">
                  Blue Garnet – Gold
                </TabsTrigger>
                <TabsTrigger value="platinum" className="rounded-full">
