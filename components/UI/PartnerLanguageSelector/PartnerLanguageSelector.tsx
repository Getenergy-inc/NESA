...
import { usePartnerLanguage, LANGUAGES, type Language } from '@/lib/i18n/PartnerLanguageContext';

const PartnerLanguageSelector: React.FC = () => {
  const { currentLanguage, setLanguage, t } = usePartnerLanguage();
          ...
          >
            ...
            <div className="px-4 py-3 bg-gradient-to-r from-primaryGold/10 to-deepGold/10 border-b border-gray-200/50">
              <p className="text-sm font-semibold text-gray-700 flex items-center gap-2">
                ...
                {t('partner.languageSelector.label')}
              </p>
            </div>
...
export default PartnerLanguageSelector;