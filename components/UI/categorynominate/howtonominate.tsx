      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col gap-2 text-[#1E1E1E] text-sm md:text-base lg:text-lg leading-relaxed font-inter">
          <div className="flex items-start gap-3">
            ...
            <p>Nomination Phase: Submit your entry now!</p>
          </div>

          <div className="flex items-start gap-3">
            <span className="w-2.5 h-2.5 mt-2 rounded-full bg-[#F7A500] flex-shrink-0"></span>
            <p>
              Judges Arena Screening: Independent evaluation by industry
              experts.
            </p>
          </div>
          ...
          <div className="flex items-start gap-3">
            <span className="w-2.5 h-2.5 mt-2 rounded-full bg-[#F7A500] flex-shrink-0"></span>
            <p>
              Voting Begins: Public voting using AFRI-Gold Coins (Proceeds fund
              scholarships)
            </p>
          </div>
          ...
          <div className="flex items-start gap-3">
            <span className="w-2.5 h-2.5 mt-2 rounded-full bg-[#F7A500] flex-shrink-0"></span>
            <p>
              Award Ceremony: Winners announced on October 16, 2025 at the
              prestigious NESA Africa Awards Dinner.
            </p>
          </div>
        </div>
      </div>
