                ...
                >
                  {!action.requiresAuth || isAuthenticated ? (
                    <Link href={action.link} className="block h-full">
                      <div
                        className={`bg-gradient-to-br from-[#191307]/80 to-[#33270E]/60 backdrop-blur-sm border border-gray-400/20 rounded-xl p-6 hover:border-gray-400/40 transition-all duration-300 h-full cursor-pointer group-hover:transform group-hover:scale-105 ${
                          action.featured
                            ? "border-gray-400/40 bg-gradient-to-br from-gray-400/5 to-gray-600/5"
                            : ""
                        }`}
                      >
                        <div className="text-center h-full flex flex-col">
                          ...
                          <div
                            className={`w-16 h-16 bg-gradient-to-r ${action.color} rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300`}
                          >
                          ...
                          <div
                            className={`bg-gradient-to-r ${action.color} text-white px-6 py-3 rounded-full font-semibold text-sm hover:shadow-lg transition-all duration-300 w-full mt-auto text-center`}
                          >
                            {action.buttonText}
                          </div>
                        </div>
                    ...
                    >
                      <div className="text-center h-full flex flex-col">
                        ...
                        <div
                          className={`w-16 h-16 bg-gradient-to-r ${action.color} rounded-full flex items-center justify-center mx-auto mb-4 opacity-75`}
                        >
                          <action.icon className="w-8 h-8 text-white" />
                        </div>
