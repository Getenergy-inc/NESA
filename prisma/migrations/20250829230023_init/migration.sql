...
-- CreateIndex
CREATE UNIQUE INDEX "Endorsement_email_key" ON "public"."Endorsement"("email");
...
-- CreateIndex
CREATE UNIQUE INDEX "VerificationToken_identifier_type_key" ON "public"."VerificationToken"("identifier", "type");
