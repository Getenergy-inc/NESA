  ...
  (config) => {
    ...
    if (token) {
      ...
      if (token === "verified-token") {
        ...
        const testJWT =
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiJ0ZXN0LXVzZXItaWQiLCJlbWFpbCI6InRlc3RAdGVzdC5jb20iLCJyb2xlIjoiVVNFUiIsImlhdCI6MTYzMjE1MDQwMCwiZXhwIjoxOTQ3NTEwNDAwfQ.testSignatureForDevelopment";
