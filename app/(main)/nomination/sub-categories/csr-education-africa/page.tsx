...
const CSRInEducationAwardPage = () => {
  ...
  const categories: Category[] = [
    ...
    },
    {
      ...
      description:
        "Acknowledges oil and gas  companies for their investments in STEM education, university  collaborations, and community ....",
      image: "/images/nesa-card2.png",
    },
    {
      title: "Food And Beverages CSR in Education Award",
      description:
        "Celebrates food  and beverage companies in nutrition education, school feeding  programs, and educational resources.",
      image: "/images/nesa-card2.png",
    },
    {
      title: "Manufacturing CSR in Education Award",
      description:
        "Recognizes  manufacturing companies for vocational training, educational  sponsorships, and support in infrastructure.",
      image: "/images/nesa-card2.png",
    },
    {
      title: "Aviation CSR in Education Award",
      description:
        "Honors aviation companies  for educational outreach and aviation-focused educational  programs.",
      image: "/images/nesa-card2.png",
    },
    {
      title: "Technology And ICT CSR in Education Award",
      description:
        "Acknowledges  tech companies for initiatives in digital education, ICT training,  and innovative educational resources.",
      image: "/images/nesa-card2.png",
    },
    {
      title: "Real Estate and Construction CSR in Education Award ",
      description:
        "Recognizes contributions in educational infrastructure  development and community projects.",
      image: "/images/nesa-card2.png",
    },
    {
      title: "Retail and E-commerce CSR in Education Award ",
      description:
        "Honors retail  and e-commerce companies for educational support through  funding, resources, and community projects.",
      image: "/images/nesa-card2.png",
    },
    {
    ...
    },
    {
      ...
      description:
        "Celebrates  pharmaceutical companies' efforts in health education and  support for medical education.",
      image: "/images/nesa-card2.png",
    },
    {
      title: "Insurance CSR in Education Award",
      description:
        ": Recognizes insurance  companies for contributions to financial literacy education and  educational initiatives.",
      image: "/images/nesa-card2.png",
    },
    {
      title: "Conglomerates And Diversified Businesses CSR in Education Award",
      description:
        "Acknowledges the wide-ranging support of  conglomerates in various educational sectors.",
      image: "/images/nesa-card2.png",
    },
    {
      title: "Media And Entertainment CSR in Education Award",
      description:
        "Honors  media and entertainment companies for educational content  creation, scholarships, and outreach programs.",
      image: "/images/nesa-card2.png",
    },
    {
      title: "Agriculture And Agribusiness CSR in Education Award",
      description:
        "Celebrates agribusinesses for their role in agricultural education  and community training programs",
      image: "/images/nesa-card2.png",
    },
    {
      title: "Health Care And Hospitals CSR in Education Award",
      description:
        "Recognizes healthcare providers for contributions to medical  education and community health initiatives.",
      image: "/images/nesa-card2.png",
    },
    {
      title: "Professional Services CSR in Education Award",
      description:
        "Acknowledges  professional service firms for support in business and financial  education, internships, and training programs.",
      image: "/images/nesa-card2.png",
    },
    {
      title: "Fintech CSR in Education Award",
      description:
        "Honors fintech companies for  innovative approaches to financial education and literacy.",
      image: "/images/nesa-card2.png",
    },
    {
      title: "Microfinance Banks CSR in Education Award",
      description:
        " Recognizes  microfinance banks for their educational support initiatives,  particularly in underprivileged communities.",
      image: "/images/nesa-card2.png",
    },
    {
      title: "Emerging Telecommunications CSR in Education Award",
      description:
        "Honors smaller and emerging telecom companies for their efforts  in educational CSR",
      image: "/images/nesa-card2.png",
    },
    {
    ...
    },
    {
      ...
      description:
        "Recognizes  real estate developers for their contributions to educational  infrastructure and community educational initiatives.",
      image: "/images/nesa-card2.png",
    },
    {
      title: "Hotels CSR in Education Award ",
      description:
        "Acknowledges sory 3ftware and technology companies for their  contributions to educational technology and digital literacy.",
      image: "/images/nesa-card2.png",
    },
  ];
