...
const EduTechAwardCategoryPage = () => {
  ...
  const prevSlide = useCallback(() => {
    setCurrentIndex(
      (prevIndex) =>
        (prevIndex - 1 + subcategories.length + 1) % (subcategories.length + 1)
    );
  }, [subcategories.length]);
      ...
      <div className="bg-white w-full">
        <div className="max-w-6xl mx-auto py-12 px-4">
          <div className="mb-12">
            ...
            <p className="mb-4">
              To acknowledge the contributions of EduTech organizations that
              have leveraged technology to enhance educational experiences and
              outcomes in Nigeria and across Africa. This award aims to promote
              further innovation and investment in educational technology,
              highlighting the importance of EduTech in achieving educational
              excellence.
            </p>
          </div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <div>
                  ...
                  recognition for their contributions to educational technology,
                  it provides opportunity to network with other award winners,
                  educational leaders, and policymakers, and it increases
                  visibility through media coverage and promotional activities
                  associated with the NESA-Africa/Nigeria 2025 Awards.
                </div>
              </li>
              <li className="flex items-start">
                <span className="w-2 h-2 mt-2 mr-2 rounded-full bg-gradient-to-r from-[#FFC247] to-[#E48900] border border-dotted border-[#FFC247]"></span>
                <div>
                  <strong>Nigeria and Africa:</strong> It encourages more
                  eduTech innovations, leading to improved educational
                  infrastructure and resources, and it empowers communities
                  through better education, leading to social and economic
                  development, and it inspires other organizations to contribute
                  to educational technology, creating a ripple effect across
                  various sectors.
                </div>
              </li>
            </ul>
