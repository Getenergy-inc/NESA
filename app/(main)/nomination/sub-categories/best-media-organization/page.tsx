...
const MediaEducationalAdvocacyAwardPage = () => {
  const categories: Category[] = [
    ...
    },
    {
      ...
      description:
        "Acknowledges TV stations and networks for high-quality educational shows, documentaries, and news segments",
      image: "/images/nesa-card2.png",
    },
  ];
      ...
      <div className="bg-white w-full">
        <div className="max-w-6xl mx-auto py-12 px-4">
          <div className="mb-12">
            ...
            <p className="mb-4">
              To recognize media organizations that have made significant
              contributions to educational advocacy through their content. This
              award celebrates media outlets that have effectively utilized
              their platforms to promote education, raise awareness about
              educational issues, and advocate for educational reforms and
              initiatives (Media Organization in Nigeria).
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <div>
                  <strong>Awardees:</strong> Media organizations receive
                  ...
                  among media outlets to promote innovation and excellence.
                  Positive publicity and enhanced reputation for the winning
                  organizations, opportunities for staff professional
              ...
              <li className="flex items-start">
                <span className="w-2 h-2 mt-2 mr-2 rounded-full bg-gradient-to-r from-[#FFC247] to-[#E48900] border border-dotted border-[#FFC247]"></span>
                <div>
                  <strong>Nigeria and Africa:</strong> Encourages media to
                  prioritize innovation and excellence in educational content,
                  leading to improved educational resources and services, it
                  empowers students and staff through better access to
                  information and support services, inspires other media outlets
                  to adopt successful initiatives and best practices, supports
                  the achievement of the Sustainable Development Goals (SDGs) by
                  enhancing quality education and promoting lifelong learning
                  opportunities.
                </div>
              </li>
            </ul>
