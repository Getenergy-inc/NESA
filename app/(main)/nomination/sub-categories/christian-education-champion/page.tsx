  ...
  const categories: Category[] = [
    {
      ...
      description:
        "This category honors the substantial contributions of Christian organizations to the Nigerian educational landscape, covering infrastructure development, moral and ethical education, and much more",
    ...
    },
    {
      ...
      description:
        "Recognizes Christian organizations for innovative educational programs and impactful community engagement.",
      image: "/images/nesa-card2.png",
    },
    {
      title:
      ...
      description:
        "Acknowledges Christian groups for their significant contributions to educational infrastructure and resources.",
      image: "/images/nesa-card2.png",
    },
    {
      title:
      ...
      description:
        "Celebrates Christian entities that offer scholarships and moral education based on Christian teachings.",
      image: "/images/nesa-card2.png",
    },
    {
      title:
      ...
      <div className="bg-white w-full">
        <div className="max-w-6xl mx-auto py-12 px-4">
          <div className="mb-12">
            ...
            <p className="mb-4">
              This Award recognizes the profound impact that Christian
              organizations have made on education in Nigeria over the past
              decade. It celebrates the unique and influential efforts of
              Christian groups in advancing educational outcomes and community
              well-being, encouraging further innovation and collaboration in
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <div>
                  ...
                  their contributions to education through Christian
                  initiatives.
                </div>
              </li>
              <li className="flex items-start">
                <span className="w-2 h-2 mt-2 mr-2 rounded-full bg-gradient-to-r from-[#FFC247] to-[#E48900] border border-dotted border-[#FFC247]"></span>
                <div>
                  <strong>Nigeria:</strong> Showcases the vital role of
                  Christian organizations in education, fostering a deeper
                  appreciation and understanding of their contributions to
                  societal development. This recognition also encourages other
