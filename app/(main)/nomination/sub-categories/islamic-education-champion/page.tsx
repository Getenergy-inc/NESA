...
const IslamicFaithEducationAwardPage = () => {
  ...
  const categories: Category[] = [
    ...
    },
    {
      ...
      description:
        "Honors Islamic organizations for pioneering educational initiatives and effective community development efforts",
      image: "/images/nesa-card2.png",
    },
    {
      title:
      ...
      description:
        "Commends Islamic organizations for enhancing educational facilities and providing essential resources.",
      image: "/images/nesa-card2.png",
    },
    {
      title:
      ...
      description:
        "Recognizes Islamic organizations for providing educational aid and emphasizing Islamic ethical teachings.",
      image: "/images/nesa-card2.png",
    },
    {
      title:
      ...
      description:
        "Salutes joint efforts by Christian and Islamic groups to promote interfaith dialogue and understanding through education, fostering a unified approach.",
      image: "/images/nesa-card2.png",
    },
  ];
  ...
  const handleNominate = (category: Category) => {
    router.push(
      `/nominateform?type=${encodeURIComponent(
        "Best Faith-Based Organization in Education"
      )}` +
      ...
      <div className="bg-white w-full">
        <div className="max-w-6xl mx-auto py-12 px-4">
          <div className="mb-12">
            ...
            <p className="mb-4">
              The purpose of this award is to Recognize and honor the
              significant contributions of Islamic organizations in the
              educational sector in Nigeria over the past decade, Highlight the
              diverse ways in which Islamic organizations have enhanced
              educational infrastructure, resources, and moral education and
              Encourage continued innovation and collaboration among Islamic
              organizations to further improve educational outcomes and
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <div>
                  <strong>Awardees:</strong> Gain national recognition,
                  increased opportunities for collaboration, and validation for
                  their contributions to education through Islamic initiatives.
                </div>
              </li>
              <li className="flex items-start">
                <span className="w-2 h-2 mt-2 mr-2 rounded-full bg-gradient-to-r from-[#FFC247] to-[#E48900] border border-dotted border-[#FFC247]"></span>
                <div>
                  <strong>Nigeria:</strong> Showcases the vital role of Islamic
                  organizations in education, fostering a deeper appreciation
                  and understanding of their contributions to societal
                  development. This recognition also encourages other
                  organizations to engage in similar efforts, promoting a
