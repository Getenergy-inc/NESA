...
const PoliticalLeadersRecognitionPage = () => {
  ...
  const subcategories: Category[] = [
    ...
    },
    {
      ...
      description:
        "This category recognizes political leaders who have initiated or significantly expanded scholarship programs...",
      image: "/images/nesa-card2.png",
    },
    {
      title:
      ...
      description:
        "This category honors political leaders who have made substantial investments in educational infrastructure...",
      image: "/images/nesa-card2.png",
    },
    {
  ...
  const handleNominate = (category: Category) => {
    router.push(
      `/nominateform?type=${encodeURIComponent(
        "Best Political Leaders Educational Support Services"
      )}` +
      ...
      <div className="bg-[#FFF5E0] w-full">
        <div className="max-w-6xl mx-auto py-12 px-4">
          <h2 className="text-3xl font-bold mb-8 relative inline-block text-black">
            ...
            <br />
            the Best Educational Support Services Sub-categories
