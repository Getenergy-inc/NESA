  ...
  const categories: Category[] = [
    {
      ...
      description:
        "This award is established to recognize and honor libraries in Nigerian tertiary institutions that demonstrate excellence in providing access to information, fostering a culture of reading and research, and supporting academic success. This award celebrates libraries that have implemented innovative services, resources, and programs to enhance the educational experience of students and staff.",
      image: "/images/nesa-card2.png",
    },
    {
      title: "Best University Library in Nigeria (Public)",
      description:
        "This award assesses how effectively states allocate and utilize their educational budget to enhance infrastructure, resources, educator...",
      image: "/images/nesa-card2.png",
    },
    {
      title: "Best University Library in Nigeria (Private)",
      description:
        "Recognizes states that have made significant contributions to integrating STEM education and technology into their educational systems.",
      image: "/images/nesa-card2.png",
    },
    {
      title: "Best Polytechnic Library in Nigeria (Public)",
      description:
        "Focuses on states that have implemented innovative teaching methods, developed superior school facilities, offered exceptional sports...",
      image: "/images/nesa-card2.png",
    },
    {
    ...
    <div className="min-h-screen bg-[#FFF5E0]">
      ...
      <div className="max-w-6xl mx-auto py-12 px-4">
        <h2 className="text-3xl font-bold mb-8 relative inline-block">
          The best library in Nigerian tertiary institutions Award
          Sub-Categories
      ...
      <div className="bg-white w-full">
        <div className="max-w-6xl mx-auto py-12 px-4">
          <div className="mb-12">
            ...
            <p className="mb-4">
              To recognize and honor libraries in Nigerian tertiary institutions
              that demonstrate excellence in providing access to information,
              fostering a culture of reading and research, and supporting
              academic success. This award celebrates libraries that have
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <div>
                  <strong>Awardees:</strong> Libraries receive national
                  recognition for their excellence and contributions to
                  education, increased opportunities for funding and resources
                  to support further development, sharing of best practices
                  among libraries to promote innovation and excellence. Positive
                  publicity and enhanced reputation for the winning libraries,
              ...
              <li className="flex items-start">
                <span className="w-2 h-2 mt-2 mr-2 rounded-full bg-gradient-to-r from-[#FFC247] to-[#E48900] border border-dotted border-[#FFC247]"></span>
                <div>
                  <strong>Nigeria and Africa:</strong> Encourages libraries to
                  ...
                  services, inspires other libraries to adopt successful
