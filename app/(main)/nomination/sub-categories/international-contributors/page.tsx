...
const InternationalBilateralAwardPage = () => {
  const categories: Category[] = [
    ...
    },
    {
      ...
      description:
        "This category recognizes political leaders who have initiated or significantly expanded scholarship programs, providing financial support to students in need.",
      image: "/images/nesa-card2.png",
    },
    {
      title:
      ...
      description:
        "This category honors political leaders who have made substantial investments in educational infrastructure, including technology and training programs to enhance teaching and learning capabilities.",
      image: "/images/nesa-card2.png",
    },
    {
      title:
      ...
      description:
        "This category recognizes political leaders who have fostered significant partnerships and collaborations that have led to improved educational outcomes, including the construction and renovation of schools.",
      image: "/images/nesa-card2.png",
    },
    {
      title:
  ...
  const handleNominate = (category: Category) => {
    router.push(
      `/nominateform?type=${encodeURIComponent(
        "Best STEM Education Champion Best International & Bilateral Contributors to EducatioN"
      )}` +
    ...
    <div className="min-h-screen bg-[#FFF5E0]">
      ...
      <div className="max-w-6xl mx-auto py-12 px-4">
        <h2 className="text-3xl font-bold mb-8 relative inline-block">
          International and Bilateral Contributors to Education Award
          Sub-categories
      ...
      <div className="bg-white w-full">
        <div className="max-w-6xl mx-auto py-12 px-4">
          <div className="mb-12">
            ...
            <p className="mb-4">
              To celebrate the significant contributions of international
              organizations, bilateral partnerships, and foreign governments to
              the advancement of education in Nigeria. This award recognizes
              entities that have demonstrated exceptional commitment and impact
              through educational programs, funding, and initiatives that align
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <div>
                  <strong>Awardees:</strong> International and bilateral
                  entities receive national recognition for their contributions
                  to education in Nigeria, Increased opportunities for funding
                  and resources to support further educational initiatives and
                  Sharing of best practices among international and bilateral
                  entities to promote innovation and excellence.
                </div>
              </li>
              <li className="flex items-start">
                <span className="w-2 h-2 mt-2 mr-2 rounded-full bg-gradient-to-r from-[#FFC247] to-[#E48900] border border-dotted border-[#FFC247]"></span>
                <div>
                  <strong>Nigeria and Africa:</strong> Encourages international
                  and bilateral entities to prioritize educational support,
                  leading to improved access and quality of education, Empowers
                  communities through better access to resources and educational
                  opportunities, Inspires other entities to adopt successful
