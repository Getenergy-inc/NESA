  ...
  const categories: Category[] = [
    {
      ...
      description:
        "This award aims to recognize and honor research institutes in Nigeria that have made significant contributions to the educational sector through innovative research and development (R&D) initiatives. This award celebrates institutes that have demonstrated excellence in conducting impactful research, developing educational technologies, and implementing projects that enhance educational quality and accessibility.",
      image: "/images/nesa-card2.png",
    },
    {
      title: "Best Agricultural Research Institute in Nigeria",
      description:
        "Recognizes research institutes that have made significant contributions to agricultural education and development through innovative research and initiatives.",
      image: "/images/nesa-card2.png",
    },
    {
      title: "Best Pharmaceutical And Drug Research Institute in Nigeria",
      description:
        "Honors research institutes that excel in pharmaceutical and drug research, contributing to advancements in medical education and healthcare advancements.",
      image: "/images/nesa-card2.png",
    },
    {
      title: "Best Environmental And Ecological Research Institute in Nigeria",
      description:
        "Celebrates research institutes that conduct groundbreaking research in environmental and ecological fields, contributing to sustainability education and awareness.",
      image: "/images/nesa-card2.png",
    },
  ];
  ...
  const handleNominate = (category: Category) => {
    router.push(
      `/nominateform?type=${encodeURIComponent(
        "Best Research & Development Contribution by Institutes"
      )}` +
      ...
      <div className="max-w-6xl mx-auto py-12 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {categories.slice(1).map((category, index) => (
            <div
              key={index}
              className="bg-[#191307] rounded-3xl overflow-hidden shadow-lg transition-transform hover:scale-105 flex flex-col p-6 w-full h-full"
            >
      ...
      <div className="bg-white w-full">
        <div className="max-w-6xl mx-auto py-12 px-4">
          <div className="mb-12">
            ...
            <p className="mb-4">
              To recognize and honor research institutes in Nigerian that
              demonstrate excellence in providing access to information,
              fostering a culture of reading and research, and supporting
              academic success. This award celebrates institutes that have
              implemented innovative services, resources, and programs to
              enhance the educational experience of students and staff.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <div>
                  <strong>Awardees:</strong> Research institutes receive
                  national recognition for their excellence and contributions to
                  education, increased opportunities for funding and resources
                  to support further development, sharing of best practices
                  among institutes to promote innovation and excellence.
                  Positive publicity and enhanced reputation for the winning
                  institutes, opportunities for staff professional development
                  and training.
                </div>
              </li>
              <li className="flex items-start">
                <span className="w-2 h-2 mt-2 mr-2 rounded-full bg-gradient-to-r from-[#FFC247] to-[#E48900] border border-dotted border-[#FFC247]"></span>
                <div>
                  <strong>Nigeria and Africa:</strong> Encourages institutes to
                  prioritize innovation and excellence, leading to improved
                  educational resources and services, it empowers students and
                  staff through better access to information and support
                  services, inspires other institutes to adopt successful
                  initiatives and best practices, supports the achievement of
                  the Sustainable Development Goals (SDGs) by enhancing quality
